...
public class StringUtil {
	public static final HashMap<String, String> theNumToGb2312CharMap = new HashMap<String, String>();
	...
	static {
		theNumToGb2312CharMap.put("+", "��");
		theNumToGb2312CharMap.put("-", "��");
		theNumToGb2312CharMap.put("0", "��");
		theNumToGb2312CharMap.put("1", "һ");
		theNumToGb2312CharMap.put("2", "��");
		theNumToGb2312CharMap.put("3", "��");
		theNumToGb2312CharMap.put("4", "��");
		theNumToGb2312CharMap.put("5", "��");
		theNumToGb2312CharMap.put("6", "��");
		theNumToGb2312CharMap.put("7", "��");
		theNumToGb2312CharMap.put("8", "��");
		theNumToGb2312CharMap.put("9", "��");
		theNumToGb2312CharMap.put("10", "ʮ");
		theNumToGb2312CharMap.put("100", "��");
		theNumToGb2312CharMap.put("1000", "ǧ");
		theNumToGb2312CharMap.put("10000", "��");
	}
